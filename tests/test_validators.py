...
class TestLengthValidator:
    ...
    def test_all_posts_in_optimal_range(self):
        ...
        word_counts = [220, 235, 250, 265, 280]  # Varied within optimal range (220-280)
        posts = []

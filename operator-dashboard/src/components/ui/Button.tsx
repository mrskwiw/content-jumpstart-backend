/* eslint-disable react-refresh/only-export-components -- intentional mixed export: shadcn component + `buttonVariants` cva consts share this module by design (HMR/DX rule, not correctness). */

...
export const FEATURE_REGISTRY: RegistryFeature[] = [
  ...
  },
  {
    ...
    description: 'Extract client narratives to power Personal Story, Things I Got Wrong, What I Learned From, Inside Look, and Milestone posts',
    category: 'app_feature',
    status: 'incomplete',
  },
  {
  ...
  { id: 'template_11', templateId: 11, name: 'What I Learned From',   description: 'Learning journey and transformation — recommended Story Mining for narrative depth', category: 'template', status: 'complete',   completedAt: '2026-04-01' },
  { id: 'template_12', templateId: 12, name: 'Inside Look',           description: 'Behind-the-scenes process reveal — recommended Story Mining for process narratives', category: 'template', status: 'incomplete' },

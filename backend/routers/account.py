...
from backend.services.account_state import BLOCKED_STATES, EXPIRED_STATES, account_state
...
class AccountStatus(BaseModel):
    ...
    # work; spending is blocked. Distinct from expired, which closes everything.
    spend_blocked: bool
    plan_id: str | None
...
def get_account_status(
    ...
    return AccountStatus(
        state=state,
        expired=state in EXPIRED_STATES,
